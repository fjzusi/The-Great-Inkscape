...
class BuildExe:
	def __init__(self):
		...
		#Name of program
		self.project_name = "The Great Inkscape"
 
		#Project url
		self.project_url = "about:none"
 
		#Version of program
		self.project_version = "0.0.0.2"
 
		#License of the program
		self.license = "GPL License"
 
		#Auhor of program
		self.author_name = "JoeDono"
		self.author_email = "webmaster@littlehivestudios.com"
		self.copyright = "Copyright (c) 2012 Fred Zusi."
		...
		self.extra_datas = ["Data", "Image", "Sound"]
